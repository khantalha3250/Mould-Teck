  ...
  {isOpen && (
    <div ref={menuRef} className="lg:hidden bg-white bg-opacity-90 z-50">
      <div className="flex flex-col space-y-4 px-6 py-4">
        ...
        <Link to="/services" className="text-black hover:text-yellow-500" onClick={toggleMenu}>
          Services
        </Link>
        <Link to="/contact" className="text-black hover:text-yellow-500" onClick={toggleMenu}>
          Contact
        </Link>
